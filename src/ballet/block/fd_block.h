...
struct fd_rawtxn_b {
  ...
  void * raw; /* TODO: This should probably be a wksp offset */
...
struct __attribute__((aligned(64))) fd_entry {
  /* This point is 64-byte aligned */

  /* TODO: These should be moved into a private header.
     `fd_entry_join` can move the pointer past these 16 bytes. */
